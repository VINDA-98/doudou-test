module github.com/VINDA-98/doudou-test
...
require (
	...
	github.com/unionj-cloud/go-doudou/v2 v2.1.5
)
...
require (
	...
	github.com/wubin1989/nacos-sdk-go/v2 v2.1.2-0.20221024120645-0288f53fdaa8 // indirect
